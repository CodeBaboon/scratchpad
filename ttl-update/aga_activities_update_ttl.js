...
export const TABLE_NAME = "automatic-grading-adjustments-service-prod-activities";

export const updateItem = async (_key, ttl) => {
    const params = {
        Statement: `UPDATE "` + TABLE_NAME + `" SET ttl=? WHERE pk1=?`,
